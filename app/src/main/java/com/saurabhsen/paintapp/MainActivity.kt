package com.saurabhsen.paintapp
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showBrushChooserDailog(){
        val brushDailog = Dialog(this)
        brushDailog.setContentView(R.layout.dailog_brush_size)
        brushDailog.setTitle("Brush Size: ")
        val smallBtn = brushDailog.ib_small_brush
        val mediumBtn = brushDailog.ib_medium_brush
        val largeBtn = brushDailog.ib_large_brush
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        if(requestCode == STORAGE_PERMISSION){
            if(grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                Toast.makeText(this,"Permission granted and now you can use storage file!",Toast.LENGTH_LONG).show()
            }
        }else{
            Toast.makeText(this,"Sorry! You denied the permission",Toast.LENGTH_LONG).show()
        }
    }
    ...
    private inner class BitmapAsyncTask(val mBitmap: Bitmap): AsyncTask<Any,Void,String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            if(result!!.isNotEmpty()){
                Toast.makeText(this@MainActivity,"Saved Image Successfully: $result", Toast.LENGTH_LONG).show()
            }else{
